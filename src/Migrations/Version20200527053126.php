 ...
 */
final class Version20200527053126 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE track_file CHANGE metadata_title metadata_title VARCHAR(255) DEFAULT NULL, CHANGE metadata_artists metadata_artists LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE metadata_album metadata_album VARCHAR(255) DEFAULT NULL, CHANGE metadata_album_artists metadata_album_artists VARCHAR(255) DEFAULT NULL, CHANGE metadata_track_no metadata_track_no INT DEFAULT NULL, CHANGE metadata_genre metadata_genre VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE track ADD metadata_title VARCHAR(255) DEFAULT NULL, ADD metadata_artists LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', ADD metadata_album_artists VARCHAR(255) DEFAULT NULL, ADD metadata_album VARCHAR(255) DEFAULT NULL, ADD metadata_track_no INT DEFAULT NULL, ADD metadata_genre VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE track DROP metadata_title, DROP metadata_artists, DROP metadata_album_artists, DROP metadata_album, DROP metadata_track_no, DROP metadata_genre');
